...
/** Domain types for Payment Fraud Sentinel — ported verbatim from
 * apps/paymentFraudSentinel-ui/src/lib/types.ts (kept in sync by hand).
 *
 ...
 * the pipeline never sees (persisted in localStorage). */
