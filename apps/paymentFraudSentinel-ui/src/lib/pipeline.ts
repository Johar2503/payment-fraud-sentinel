 ...
 *
 * The pipeline has three webhook sources:
...
// ---------------------------------------------------------------------------
// usePipeline — starts (or re-attaches to) the three tasks and exposes the
...
async function acquireToken(
	client: NonNullable<ReturnType<typeof useShellConnection>['client']>,
	source: SourceId,
	forceNew = false,
): Promise<string> {
